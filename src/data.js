const data = [
  {
    id: 1,
    nameBoth: { first: "Waylin", last: "Lumsdon" },
    city: "Likiep",
  ...
  {
    id: 2,
    nameBoth: { first: "Hastie", last: "Beardsdale" },
    city: "Dzvinogrud",
    country: "Ukraine",
    employer: "Vinte",
  ...
  {
    id: 3,
    nameBoth: { first: "Hyacinth", last: "Spiller" },
    city: "Gaxung",
    country: "China",
    employer: "Kanoodle",
    title: "Operator",
  ...
  {
    id: 4,
    nameBoth: { first: "Drusi", last: "Gainsborough" },
    city: "Chupa",
    country: "Russia",
    employer: "Skivee",
  ...
  {
    id: 5,
    nameBoth: { first: "Hirsch", last: "Pywell" },
    city: "Anopog",
    country: "Philippines",
    employer: "Topiczoom",
    title: "Developer IV",
  ...
  {
    id: 6,
    nameBoth: { first: "Worthington", last: "Langfat" },
    city: "Utena",
    country: "Lithuania",
    employer: "Npath",
  ...
  {
    id: 7,
    nameBoth: { first: "Field", last: "Frawley" },
    city: "Soio",
    country: "Angola",
    employer: "Voonyx",
  ...
  {
    id: 8,
    nameBoth: { first: "Jolyn", last: "Ubank" },
    city: "Aviá Terai",
    country: "Argentina",
    employer: "Eabox",
    title: "Actuary",
  ...
  {
    id: 9,
    nameBoth: { first: "Marion", last: "Santori" },
    city: "Liverpool",
  ...
  {
    id: 10,
    nameBoth: { first: "Perri", last: "Koopman" },
    city: "Isoka",
    country: "Zambia",
    employer: "Jayo",
  ...
  {
    id: 11,
    nameBoth: { first: "Danit", last: "Berg" },
    city: "New York City",
  ...
  {
    id: 12,
    nameBoth: { first: "Hadlee", last: "Piolli" },
    city: "Nkurenkuru",
    country: "Namibia",
    employer: "Rhybox",
  ...
  {
    id: 13,
    nameBoth: { first: "Trev", last: "Upwood" },
    city: "Santa Elena",
    country: "Mexico",
    employer: "Devpoint",
  ...
  {
    id: 14,
    nameBoth: { first: "Dex", last: "Mirando" },
    city: "Issia",
    country: "Ivory Coast",
    employer: "Quinu",
  ...
  {
    id: 15,
    nameBoth: { first: "Say", last: "Gooderick" },
    city: "Lousado",
    country: "Portugal",
    employer: null,
    title: null,
  ...
  {
    id: 16,
    nameBoth: { first: "Shirlee", last: "Senyard" },
    city: "Makrochóri",
    country: "Greece",
    employer: "Zoomlounge",
    title: "Human Resources Manager",
  ...
  {
    id: 17,
    nameBoth: { first: "Brenna", last: "Wardell" },
  ...
  {
    id: 18,
    nameBoth: { first: "Moshe", last: "Fatkin" },
    city: "Pojan",
    country: "Albania",
    employer: "Babbleopia",
  ...
  {
    id: 19,
    nameBoth: { first: "Dari", last: "Lomasny" },
    city: "Aghavnadzor",
    country: "Armenia",
    employer: "Lazzy",
  ...
  {
    id: 20,
    nameBoth: { first: "Adena", last: "Colbrun" },
    city: "Seres",
    country: "Philippines",
    employer: "Jabbercube",
  ...
  {
    id: 21,
    nameBoth: { first: "Orelie", last: "Reside" },
    city: "Sukpak",
    country: "Russia",
    employer: "Oyoloo",
    title: "Geologist II",
  ...
  {
    id: 22,
    nameBoth: { first: "Fraser", last: "Furnival" },
    city: "Damaishan",
    country: "China",
    employer: "Viva",
  ...
  {
    id: 23,
    nameBoth: { first: "Darryl", last: "Sarle" },
    city: "Szydłowo",
    country: "Poland",
    employer: "Linktype",
    title: "Professor",
  ...
  {
    id: 24,
    nameBoth: { first: "Cecilius", last: "Barrabeale" },
    city: "Tangtou",
    country: "China",
    employer: "Feedfire",
  ...
  {
    id: 25,
    nameBoth: { first: "Mikaela", last: "Jeannequin" },
    city: "Tha Maka",
    country: "Thailand",
    employer: null,
    title: null,
